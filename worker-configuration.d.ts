/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f80a30de1322955710f109b9eef8559f)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	GITHUB_OWNER: "mrson93";
	GITHUB_REPOSITORY: "busca-seguidores-bsky";
	GITHUB_WORKFLOW: "auto-follow.yml";
	GITHUB_REF: "main";
	GITHUB_TOKEN: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare-scheduler/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPOSITORY" | "GITHUB_WORKFLOW" | "GITHUB_REF" | "GITHUB_TOKEN">> {}
}
